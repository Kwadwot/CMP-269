...
//            System.out.println("Handling client communication in the thread:  " + Thread.currentThread().getName()
//                    + " for client: " + socket.getRemoteSocketAddress());
    ...
    public static void main(String[] args) {
        ...
        System.out.println("The chat server running. Awaiting new connections at port " + PORT + "...");
        ...
        try (ServerSocket listener = new ServerSocket(PORT)) {
            ...
            while (true) {
                ...
                Socket socket = listener.accept(); // Blocks until a client connects
                System.out.println("New client connected: " + socket.getRemoteSocketAddress());

                // Handle client communications
                ClientHandler handler = new ClientHandler(socket); // Create a thread for handling client communication
                handler.start();
